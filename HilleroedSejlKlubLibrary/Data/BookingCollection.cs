...
namespace HillerødSejlKlub.Data
{
    public class BookingCollection    
    {
        ...
        {
            {1,new Booking(Users(1), Boats(1), DateOnly.Parse("4/12/2024"),4,"hillerød sø") },
            {2,new Booking(Users(1), Boats(1), DateOnly.Parse("4/12/2024"),8,"havet") },
            {3,new Booking(Users(2), Boats(2), DateOnly.Parse("8/12/2024"),12,"hillerød flod") },
            {4,new Booking(Users(3), Boats(3), DateOnly.Parse("12/12/2024"),16,"ishøj strand") },
            {5,new Booking(Users(4), Boats(4), DateOnly.Parse("16/12/2024"),20,"lyngy sø" )},
            {6,new Booking(Users(5), Boats(5), DateOnly.Parse("24/12/2024"),20,"hillerød sø") }
